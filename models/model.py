...
from models.transformers import CoAttentionTransformerEncoder, CoAttentionTransformerEncoderLayer
...
class MCCFormerEncoderD(nn.Module):
    ...
    def __init__(
        ...
        self.transformer = CoAttentionTransformerEncoder(
            encoder_layer, num_layers=transformer_layer_num
        )
        ...
        if self.training:
            ...
            if target is not None:
                ...
                for i in range(self.max_len - 1):
                    ...
                    tmp_outputs = self.cap_predictor(
                        self.decoder(embeddings, encoded_features, tgt_mask=tgt_mask)
                    )
